                            ...
                            <TableBody>
                                {departments.map((department) => (
                                    <React.Fragment key={department._id}>
                                        <TableRow hover onClick={() => handleRowClick(department)}>
                                            <TableCell><strong>{department.name.toUpperCase()}</strong></TableCell>
                                            <TableCell>
                                                <IconButton color="primary" onClick={() => handleRowClick(department)}>
                                                    <Edit />
                                                </IconButton>
                                        ...
                                        {employees.filter(emp => emp.department && emp.department.toLowerCase() === department.name.toLowerCase()).map((emp) => (
                                            <TableRow key={emp._id}>
                                                <TableCell sx={{ pl: 4 }}>- {emp.name.charAt(0).toUpperCase() + emp.name.slice(1)}</TableCell>
